...
2. In Render, choose **Blueprint** and point it to this repository. The blueprint creates a **Static Site** service (`type: static_site` in `render.yaml`), so you do **not** need to select a Node environment manually.
